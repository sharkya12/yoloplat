...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		<th scope="row"><label for="reg_mb_email">담당 매니져</label></th>
		<td>
			<?php if ($mb_recommend=="") { ?>
					 <input type="text" name="mb_recommend" id="reg_mb_recommend" value="<?php echo $mb_recommend ?>"   class="frm_input"  size="40" maxlength="100">
			<?php }else{?>
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
			...
			<tr>
				...
				<td><input type="text" name="info_tel" class="frm_input" size="30" value="<?php echo $exp_row['info_tel'];?>"></td>
			</tr>
			<tr>
