...
<div class="tbl_frm01">
	...
	<tr>
		<td>
			<input type="submit" name="act_button" value="사용완료" class="btn_medium red" onclick="document.pressed=this.value">
			<input type="submit" name="act_button" value="예약완료 취소 - 전액환불" class="btn_medium white" onclick="document.pressed=this.value">
			<a class="btn_medium white" onclick="partial_cancellation()" class="fc_197">예약완료 취소 - 부분환불</a>
...
function partial_cancellation() {
	...
	var popup = window.open('<?php echo TB_ADMIN_URL; ?>/pop_partial_cancellation.php?od_id='+od_id_arr.reverse()+'&sort=complete','pop_partial_cancellation','width=1200,height=800,resizeable=yes');
