...
if($_POST['ca_id'] == "") {
  ...
  $value['seller_code']		  = code_uniqid('hi_exp');
  ...
  $value['business_name']		  = $_POST['business_name'];
  ...
  $value['parking']		  = $_POST['parking'];
  $value['businessHours1']		  = $_POST['businessHours1'];
  $value['businessHours2']		  = $_POST['businessHours2'];
  $value['offday_time1']		  = $_POST['offday_time1'];
  $value['offday_time2']		  = $_POST['offday_time2'];
  ...
  update("hi_exp", $value," where mb_id='{$mb_id}'");


}
goto_url(TB_ADMIN_URL.'/exp.php?type=exp&code=list');
