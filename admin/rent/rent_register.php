...
function office_category_list_ajax(value) {
	$.ajax({
		url: "./rent/rent_register_rgn_branch.ajax.php",
		type: "POST",
		dataType:"html",
		async: false,
		data: { value:value },
...
function pt_id_check(){
	...
	console.log('버튼클릭');
	$.ajax({
		url: "./rent/rent_register_id_chk.ajax.php",
		type: "POST",
		dataType:"html",
		async: false,
		data: { pt_id:pt_id },
...
<div class="tbl_frm01">
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="3">
				<select name="mb_id" required>
					...
					<?php
					$sql = "select * from hi_member where grade <> '1' and supply = '' order by name ";
					$res = sql_query($sql);
				...
				<select>
				<a href="./rent/rent_reglist.php" onclick="win_open(this,'rent_reglist','550','500','1'); return false" class="btn_small grey">선택</a>
			</td>
		</tr>
		<?php } else { ?>
			<tr>
				<th scope="row">아이디</th>
				<td colspan="3">
				<input type="text" name="mb_id" class="frm_input" value="<?php echo($mb_id);?>" readonly/>
				</td>
			</tr>
		<?php } ?> */?>
		<tr>
		...
		<tr>
			...
			<td colspan="3">
				<p><input type="text" name="company_zip" class="frm_input" size="8" maxlength="5" value="<?php echo $rent_row['company_zip'];?>"> <a href="javascript:win_zip('fregform', 'company_zip', 'company_addr1', 'company_addr2', 'company_addr3', 'company_addr_jibeon');" class="btn_small grey">주소검색</a></p>
				<p class="mart3"><input type="text" name="company_addr1" class="frm_input" size="60" value="<?php echo $rent_row['company_addr1'];?>"> 기본주소</p>
				<p class="mart3"><input type="text" name="company_addr2" class="frm_input" size="60" value="<?php echo $rent_row['company_addr2'];?>"> 상세주소</p>
				<p class="mart3"><input type="text" name="company_addr3" class="frm_input" size="60" value="<?php echo $rent_row['company_addr3'];?>"> 참고항목
...
<div class="tbl_frm02">
	...
	<tr class="item_img_fld">
		<th scope="row">대표 이미지 <span class="fc_197">(960*540)</span><?php echo $image_str; ?></th>
		<td>
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td><input type="text" name="info_tel" class="frm_input" size="30" value="<?php echo $rent_row['info_tel'];?>" numberOnly></td>
	</tr>
	<tr>
...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			<textarea name="basic_info" rows="8" cols="50"><?php echo $rent_row['basic_info'] ?></textarea>
		</td>
	</tr>
...
<div class="tbl_frm01">
	...
	<tbody>
			<th scope="row">운전자 대여조건</th>
			<td><textarea name="lend_condition"> <?php echo $rent_row['lend_condition'];?> </textarea></td>
		</tr>
	</tbody>
	</table>
</div>
...
<div class="tbl_frm01">
	...
	<tbody>
			<th scope="row">자동차 보험</th>
			<td><textarea name="insurance"> <?php echo $rent_row['insurance'];?> </textarea></td>
		</tr>
	</tbody>
	</table>
</div>
...
<div class="tbl_frm01">
	...
	<tbody>
			<th scope="row">취소 및 환불</th>
			<td><textarea name="refund"> <?php echo $rent_row['refund'];?> </textarea></td>
		</tr>
	</tbody>
	</table>
</div>
...
function fregform_submit(f) {
	...
	f.action = "./rent/rent_register_update.php";
    return true;
}
